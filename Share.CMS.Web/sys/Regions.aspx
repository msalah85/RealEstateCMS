<%@ Page Title="Regions" Language="C#" MasterPageFile="master.master" AutoEventWireup="true" EnableTheming="false" EnableViewState="false" ViewStateMode="Disabled" EnableSessionState="ReadOnly" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script src="/Scripts/sys/Common.js?v=1.1"></script>
                                    ...
                                    <div class="col-xs-12 col-sm-12">
                                        <form class="form-horizontal" role="form" id="aspnetForm">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label no-padding-right">Master region (optional)</label>
                                                <div class="col-sm-9">
                                                    <select class="col-sm-10 select2" id="RegionParentID" name="RegionParentID" data-fn-name="Regions_Names" data-placeholder="Parent region" data-allow-clear="true">
                                                        <option value=""></option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label no-padding-right">Region name <span class="text-danger">*</span></label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="col-sm-10 required" required id="RegionName" name="RegionName" placeholder="Region name" />
                                                </div>
                                            </div>
                                        </form>
                                    </div>
...
<asp:Content runat="server" ID="ddd" ContentPlaceHolderID="ContentPlaceHolder2">
    ...
    <script src="/Scripts/sys/regionsManager.js"></script>
